...
const BookingModal = ({ onBookingModalClick }: IBookingModal) => {
  ...
  const [formState, setFormState] = useState<InitialState>({
    ...
    tel: {
      ...
      error: false,
      errorText: 'Неверно введен номер телефона. Длина не больше 10 символов',
    },
    people: {
      value: '',
      regexp: REG_EXP_PEOPLE_COUNT,
      error: false,
      errorText: 'Неверно введено количество участников',
    },
  });
  ...
  return (
    <S.BlockLayer>
      <S.Modal>
        <S.ModalCloseBtn onClick={onBookingModalClick}>
        ...
        >
          ...
          <S.BookingCheckboxWrapper>
            ...
            {isValid && (
              <S.BookingInputError>Обязательное поле</S.BookingInputError>
            )}
          </S.BookingCheckboxWrapper>
        </S.BookingForm>
      </S.Modal>
